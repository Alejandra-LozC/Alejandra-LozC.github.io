var url = "https://research.typeform.com/to/YZLnIn68"; // NOTE: Replace with your typeform URL
...
function showEmbed() {
  // call this function to display the embed typeform
  window.typeformEmbed.makeWidget(embedElement, url, {
    hideHeaders: true,
    hideFooter: true,
  });
}
